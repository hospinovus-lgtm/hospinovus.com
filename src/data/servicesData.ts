export const servicesData = [
  {
    ...
    problems: [
      ...
      "Staff not aligned with NABH protocols",
      "Fear of audit failure",
      "No structured compliance system in place",
    ],

    process: [
      "Comprehensive gap analysis of current hospital practices",
      "Complete SOP creation aligned with NABH standards",
      "On-ground implementation support across departments",
      "Mock audits before final NABH inspection",
    ],
    ...
    idealFor: [
      "Hospitals planning NABH entry-level or full accreditation",
      "20–100 bed hospitals scaling operations",
      "Hospitals facing audit delays or compliance issues",
    ],
...

  {
    ...
    process: [
      "Operational audit of patient flow and bottlenecks",
      "Redesign of discharge and workflow systems",
      "Implementation of department coordination protocols",
      "Setup of monitoring dashboards and KPIs",
    ],
    ...
    idealFor: [
      "Hospitals facing discharge delays",
      "Mid-size hospitals scaling operations",
      "Facilities struggling with workflow inefficiencies",
    ],
...

  {
    ...
    problems: [
      "High staff turnover",
      "Untrained front office and billing teams",
      "Poor patient interaction experience",
      "Difficulty finding reliable admin staff",
    ],

    process: [
      "Understanding role-specific requirements",
      "Screening and shortlisting qualified candidates",
      "Structured hiring and onboarding support",
      "Optional training for operational readiness",
    ],
    ...
    idealFor: [
      "Hospitals expanding teams",
      "Facilities facing staff quality issues",
      "New hospitals setting up operations",
    ],
